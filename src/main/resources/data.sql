...
insert into app_user (id, active_flag, address, blocked_flag, email, last_name, name, password, phone, profile_image, role)
values (1, 0, 'Bulevar Oslobodjenja', 1, 'nana@DEsi.com', 'Petrovic', 'Petar', '$2a$10$IXA3XB8wgTEXkJKIB5OCyOauVHACKU01elKgnVPcRMcXjZ56iZLEC', '0654324', 'https://www.rd.com/wp-content/uploads/2017/09/01-shutterstock_476340928-Irina-Bg.jpg?resize=768,512', 1);
insert into app_user (id, active_flag, address, blocked_flag, email, last_name, name, password, phone, profile_image, role)
values (2, 0, 'Bulevar Oslobodjenja', 1, 'boki@DEsi.com', 'Petrovic', 'Bojan', '$2a$10$IXA3XB8wgTEXkJKIB5OCyOauVHACKU01elKgnVPcRMcXjZ56iZLEC', '0654324', 'https://www.rd.com/wp-content/uploads/2017/09/01-shutterstock_476340928-Irina-Bg.jpg?resize=768,512', 0);
...
insert into ride (id, baby_flag, start_time, end_time, estimated_time_minutes,
panic_flag, pets_flag, price, ride_status, driver_id) values
(2, 0, '2026-04-12 07:03:24', '2026-08-11 07:15:24', 15, 1, 0, 100.0, 'finished', 1);
insert into ride (id, baby_flag, start_time, end_time, estimated_time_minutes,
panic_flag, pets_flag, price, ride_status, driver_id) values
(3, 0, '2026-04-12 07:03:24', '2026-04-12 07:03:24', 15, 1, 0, 100.0, 'finished', 1);
insert into ride (id, baby_flag, start_time, end_time, estimated_time_minutes,
panic_flag, pets_flag, price, ride_status, driver_id) values
(4, 0, '2026-04-12 07:03:24', '2026-04-12 07:03:24', 15, 1, 0, 100.0, 'finished', 1);
insert into ride (id, baby_flag, start_time, end_time, estimated_time_minutes,
panic_flag, pets_flag, price, ride_status, driver_id) values
(5, 0, '2026-04-12 07:03:24', '2024-02-05 07:03:24', 15, 1, 0, 100.0, 'finished', 1);
insert into ride (id, baby_flag, start_time, end_time, estimated_time_minutes,
panic_flag, pets_flag, price, ride_status, driver_id) values
(6, 0, '2026-04-12 07:03:24', '2026-07-11 07:03:24', 15, 1, 0, 100.0, 'finished', 1);
insert into ride (id, baby_flag, start_time, end_time, estimated_time_minutes,
panic_flag, pets_flag, price, ride_status, driver_id) values
(7, 0, '2026-04-12 07:03:24', '2026-04-12 07:03:24', 15, 1, 0, 100.0, 'finished', 1);
insert into ride (id, baby_flag, start_time, end_time, estimated_time_minutes,
panic_flag, pets_flag, price, ride_status, driver_id) values
(8, 0, '2026-04-12 07:03:24', '2026-04-12 07:03:24', 15, 1, 0, 100.0, 'finished', 1);
